...
const adminRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'packages',        name: 'AdminPackages',        component: () => import('@/views/admin/packages.vue'),        meta: { title: '套餐管理' } },
      ...
      { path: 'ai',              name: 'AdminAi',              component: () => import('@/views/admin/ai.vue'),              meta: { title: 'AI调用记录' } },
      ...
      { path: 'payment-logs',    name: 'AdminPaymentLogs',     component: () => import('@/views/admin/payment-logs.vue'),    meta: { title: '支付流水' } },
      { path: 'refund-logs',     name: 'AdminRefundLogs',      component: () => import('@/views/admin/refund-logs.vue'),     meta: { title: '退款流水' } },
      ...
      { path: 'operation-logs',  name: 'AdminOperationLogs',   component: () => import('@/views/admin/operation-logs.vue'),  meta: { title: '操作日志' } },
      { path: 'api-logs',       name: 'AdminApiLogs',        component: () => import('@/views/admin/api-logs.vue'),       meta: { title: 'API日志' } },
      { path: 'notification-config', name: 'AdminNotificationConfig', component: () => import('@/views/admin/notification-config.vue'), meta: { title: '消息推送' } },
